...
$(function () {
  var fetchSearchGlyphys = fetchSearchGlyphys();
  window.fetchSearchGlyphys = fetchSearchGlyphys;
  var store = Object(_store_store__WEBPACK_IMPORTED_MODULE_2__["default"])();
  window.store = store;
  var receiveSearchGiphys = receiveSearchGiphys();
...
/*!**************************!*\
  !*** ./util/api_util.js ***!
  \**************************/
/*! exports provided: fetchSearchGlyphys */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchSearchGlyphys", function() { return fetchSearchGlyphys; });
/* eslint-disable no-unused-vars */

/* eslint-disable require-jsdoc */
var fetchSearchGlyphys = function fetchSearchGlyphys(searchTerm) {
  $.ajax({
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=bIbJ1vRqV79Ggqq934nK4GlxMGzsDDSP\n&limit=2")
  }).then(function (res) {
    console.log(res);
  });
};
