// You're likely already somewhat familiar with Node Package Manager (NPM) and
// how it can be used to install JavaScript dependencies called node modules
// to your app (e.g. npm install webpack -g).
...
// Much like Ruby's Gemfile, the Node Package Manager can be used with a
// manifest file that lists all of an app's JavaScript dependencies. This file
// is called package.json. While you can write this file by hand, NPM's CLI
...
// Don't worry about the default settings above; they won't affect how your
// app runs, and you can always adjust them later.
...
// You can use the --save-dev flag to specify packages for your app's
// development environment only if you are using different packages for your
// development and production servers.

// Now, anyone who gets a copy of your app can download all its dependencies
// in one fell swoop by running the following from the app's directory (with no
// arguments):
...
// bundle exec when running commands can cause errors if our app isn't
// compatible with the local version.

// To solve this issue with NPM packages, we add "scripts" for any packages
// that we intend to call from the command line. Once we've added a script for
...
// NB: Always run npm run webpack rather than webpack to minimize the chance
