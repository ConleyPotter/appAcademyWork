...
// directory. To avoid this use a .gitignore file in your project's root
// directory to prevent these files from being pushed to and pulled from your
// remote Git repositories. Create a .gitignore file in your project's root
// directory and list the files or directories you want to ignore, one per
// line. Use a trailing / to indicate a directory to ignore. To re-fetch the
// NPM modules, we can run npm install, which fetches all the modules specified
// in package.json. Then run webpack to regenerate the bundle.js and
// bundle.js.map files.
...
// You can view a full collection of useful .gitignore templates here:
...
// tools, particularly source-map. A source map makes it possible for you to 
// see the line numbers of your original source code when errors are raised. 
