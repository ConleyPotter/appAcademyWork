...
// ReactDOM.render(quotes, document.body). However, the example using JSX is 
// much simpler and easier to read.

// INERPOLATION //

// Even though it looks like HTML, JSX is still Javascript at the core. As 
// such, you can interpolate plain Javascript into JSX using { } between 
// element tags or for attribute values.
...
// JSX cannot be directly interpreted by browsers like Chrome or Firefox. 
// Instead, JSX code must be passed through a preprocessor, such as Babel, 
// that transpiles it into vanilla Javascript.

// OFFICIAL DOCUMENTATION //

// Although we'll only use JSX for developing React components, it can actually 
// be used in other applications as well. You can read more about JSX here.
