### Insepcting Complex Objects ###

# When we start dealing with complex objects, and in particular objects that hold 
# recursive references to other objects, the information provided to us by inspect 
# (what you see when you use p instead of puts) can quickly become overwhelming 
# and unreadable. To see an example of this, take a look at the output for a 
# failed spec on the PolyTreeNode class:
...
# expected: / got: difference. Which nodes are supposed to be in the children array, 
# and which are actually there?
...
# what a Node's value is. We can do this by overriding the default inspect instance 
# method for our class (this is inherited from Object).
...
# This cuases the rspec output to display as below
...
# Overriding inspect ins't always necessary, and you won't do it in every case.
# However it's an excellent option if you're ehaving trouble reading rspec
# output or finding needed data in your objects when debugging.
